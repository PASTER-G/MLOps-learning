...
.
├── dags/
│ ├── preprocess_dag.py # Обработка датасета
│ ├── compare_models_dag.py # Сравнение полученных метрик
...
- Добавление мониторинга метрик моделей для предотвращения деградации
